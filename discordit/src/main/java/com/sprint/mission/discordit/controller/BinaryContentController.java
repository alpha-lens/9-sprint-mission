...
public class BinaryContentController {
  ...
  public ResponseEntity<ApiResult<BinaryContent>> find(@PathVariable UUID binaryContentId) {
    BinaryContent binaryContent = binaryContentService.find(binaryContentId);
    return ResponseEntity
        .status(HttpStatus.OK)
        .body(ApiResult.success(binaryContent));
  }
  ...
  public ResponseEntity<ApiResult<List<BinaryContent>>> findAllByIdIn(
    ...
    return ResponseEntity
        .status(HttpStatus.OK)
        .body(ApiResult.success(binaryContents));
  }
}
